...
\begin{problem}
  ...
  \begin{image}
    \includegraphics[scale= 0.3]{window}%picture with a vertical window bar at x=1 a)
  \end{image}
  \begin{multipleChoice}
    \choice{$f(1)=3$}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice[correct]{\includegraphics[scale = 0.3]{increasingconcaveup}}
    \choice{\includegraphics[scale = 0.3]{increasingconcavedown}}
    \choice{\includegraphics[scale = 0.3]{decreasingconcavedown}}
    \choice{\includegraphics[scale = 0.3]{decreasingconcaveup}}  
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  at $t=1$ hr?
  \begin{image}
    \includegraphics[scale = 1]{speed}%graph from ASU precalculus assessment of speed of cars
  \end{image}
  \begin{multipleChoice}

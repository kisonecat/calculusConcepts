...
%  \recommendation{Elizabeth}
  Let $f$ be a polynomial function.  Assume you know that the rate of change of $f$ is always increasing on the $[a,b]$.  What can you say about $f$?
  \begin{multipleChoice}
...
\begin{problem}
	Let $f$ and $g$ be two functions satisfying the relationship $f(x) = g(4x)$.  Suppose the point $(2,3)$ is on the graph of $f$.  What follows?
	\begin{multipleChoice}
...
\begin{problem}
	Let $f$ and $g$ be two functions satisfying the relationship $f(5x) = g(x)$.  Suppose the point $(1,2)$ is on the graph of $f$.  What follows?
	\begin{multipleChoice}
...
\begin{problem}
	Let $f$ and $g$ be two functions satisfying the relationship $f(x+3) = g(x)$.  Suppose the point $(0,0)$ is on the graph of $f$.  What follows?
	\begin{multipleChoice}
...
\begin{problem}
	Let $f$ be the function defined by $f(x) = x+1$, and $g$ be the function defined by the rule $g(u) = \frac{u^2-1}{u-1}$.   Are these the same?
	\begin{multipleChoice}
...
\begin{problem}
	Let $f$ be the function defined by $f(x) = x^2+1$, and $g$ be the function defined by the rule $g(z) = z^2+1$.   Are these the same?
	\begin{multipleChoice}
...
\begin{problem}
	Let $f$ be the function defined by $f(a) = \frac{a^2}{a}$, and $g$ be the function defined by the rule $g(z) = \frac{b^3}{b^2}$.  Are these the same?
	\begin{multipleChoice}
		\choice{Since $f$ and $g$ have differing domain, they are different functions}
		\choice[correct]{$f$ and $g$ are the same function}
		\choice{$f$ and $g$ are different functions because they disagree for some inputs in their common domain}
...
\begin{problem}
  Suppose $f$ has a local minimum at $(0,f(0))$ and at $(1,f(1))$.
  What must be true about $f$?
  \begin{multipleChoice}
...
% %[EM] 
% \item Consider the following graph of a function, f, as seen through this window frame.  What can we say about f(1)?\\
% \includegraphics[scale = 0.3]{window.jpg}\\ %picture with a vertical window bar at x=1
% a)  f(1)=3\\
% b)  f(1) is defined but we do not know it's value\\
% c)  f(1) is not defined\\
% d)  We don't know anything about f(1)\\


% %[EM] 
% \item A boat is drawn closer to a dock by pulling in a rope as shown at a constant rate.  What can be said about the speed of the boat?\\
% \includegraphics[scale = 0.7]{boat.jpg}\\
% a) It is constant\\
% b) It is increasing\\
% c) It is decreasing \\
% d) It depends on how close the boat is to the dock\\

% %[EM] 


% %[EM] 
% \item Suppose you are driving a car and you accelerate from a stopped position to 60 msp with a constant acceleration.  The graph of your position as a function of time over this time interval should look most like which of the following:\\
% a) \includegraphics[scale = 0.3]{increasingconcaveup.jpg}\hspace{.5in}
% b) \includegraphics[scale = 0.3]{increasingconcavedown.jpg}\hspace{.5in}
% c) \includegraphics[scale = 0.3]{decreasingconcavedown.jpg}\hspace{.5in}
% d) \includegraphics[scale = 0.3]{decreasingconcaveup.jpg}\\

% %[PA] 
% \item Use the graphs of f and g to evaluate f(g(2)).\\
% \includegraphics[scale = 1]{f(g(2)).jpg}\\
% a) -2\\
% b) 1\\
% c) 3\\
% d) 4\\
...
% %[PA] 
% \item What is the relationship between the position of car A and car B at t=1 hr?\\
% \includegraphics[scale = 1]{speed.jpg}\\
% %graph from ASU precalculus assessment of speed of cars
% a) Car A is ahead of car B\\
% b) Car B is ahead of car A\\
...
% \includegraphics[scale = 1]{shapes.jpg}\\


% %[PA] 
% \item Using the graph below, explain the behavior of a function f on the interval from x=5 to x=12.\\
...
% %[PA] 22
% \item A baseball card increasing in value according to the function $b(t)=\frac{5}{2}t+100$, where b gives the value of the card in dollars and t is the time in years since the card was purchased.  Which of the following describe what $\frac{5}{2}$ conveys about the situation?
...
% %[PA] 24
% \item A function f is defined by the following graph.  Which of the following describes the behavior of f?\\
...
% %[PA] 25
% \item Which of the following best describes the behavior of the function f defined by $f(x)=\frac{x^2}{x-2}$?

...
%% Several questions have been borrowed from Cornell's Good Questions
%% project (grant DUE-0231154).
%% http://www.math.cornell.edu/~GoodQuestions/materials.html

%% Several questions have been borrowed from ASU's Precalculus assessment
...
%\newcommand{\PCA}[1]{\marginpar{\textbf{ASU Precalculus Assessment} #1}}
\newcommand{\PCA}[1]{}
...
\begin{problem}
  ...
  \begin{image}
    \includegraphics[scale= 0.3]{window.jpg}%picture with a vertical window bar at x=1 a)
  \end{image}
  \begin{multipleChoice}
    \choice{$f(1)=3$}
...
\begin{problem}
  Let $f$ and $g$ be two functions satisfying the relationship
  $f(x) = g(4x)$.  Suppose the point $(2,3)$ is on the graph of
  $f$.
  \begin{multipleChoice}
...
\begin{problem}
  Let $f$ be the function defined by $f(x) = x^2+1$, and $g$ be the
  function defined by the rule $g(z) = z^2+1$.  Are these the same?
  \begin{multipleChoice}
...
\begin{problem}
  Let $f$ be the function defined by $f(a) = \frac{a^2}{a}$, and $g$
  be the function defined by the rule $g(b) = \frac{b^3}{b^2}$.  Are
  these the same?
  \begin{multipleChoice}
    \choice{Since $f$ and $g$ have differing domain, they are different functions}
    \choice[correct]{$f$ and $g$ are the same function}
...
\begin{problem}
	Let $f$ be the function defined by $f(x) = \sqrt[4]{x^4}$, and $g$ be the function defined by the rule $g(y) = \left| y \right|$.  Are these the same?
	\begin{multipleChoice}
		\choice{Since $f$ and $g$ have differing domain, they are different functions}
		\choice[correct]{$f$ and $g$ are the same function}
		\choice{$f$ and $g$ are different functions because they disagree for some inputs in their common domain}
...
\begin{problem}
  \recommendation{Elizabeth}
  \GoodQuestions{Subject: Limits, 2Q}
  If $f(x)=\frac{x^2-4}{x-2}$ and $g(x)=x+2$, what can we say about
  these two functions?
  \begin{multipleChoice}
    \choice{These two functions are equal}
    \choice{These two functions are equal except at two points}
    \choice[correct]{These two functions are equal except at one point}
    \choice{These two functions are never equal}
...
\begin{problem}
  % Tests that they understand sine is not just the collection of 3 essentially different ``standard" values we have them memorize.
...
\begin{problem}
  ...
  \begin{multipleChoice}
    ...
    \choice{The graph of $f$ can only cross the line $y=7$ a
      finite number of times} \choice[correct]{The graph of $f$
      could cross the line $y=7$ infinitely many times}
  \end{multipleChoice}
\end{problem}
...
%% \begin{problem} $$ BADBAD "to the right of" ? 
%%   If $f$ and $g$ both have a vertical asymptote to the right of
%%   $x=2$, then $f(x)g(x)$ also has a vertical asymptote to the
%%   right of $x=2$.
%%   \begin{multipleChoice}
%%     \choice[correct]{True}
%%     \choice{False}
...
\begin{problem}
  ...
  close to?
  \begin{multipleChoice}
    \choice{$\frac{1}{4} \cdot f'(0)$}
    \choice{$\frac{1}{2} \cdot f'(0)$}
    \choice{$f'(0)$}
    \choice[correct]{$2 \cdot f'(0)$}
    \choice{$4 \cdot f'(0)$}
  \end{multipleChoice}
\end{problem}
...
%%BADBAD this next part should be an enumerate environment, but I am
%% unsure if it will be numbered correctly online.
  \begin{multipleChoice}
    \choice{I only}
...
\begin{problem}
  ...
  \end{image}
  \begin{multipleChoice}
    \choice{Increasing at an increasing rate}
    \choice[correct]{Increasing at a decreasing rate}
    \choice{Increasing at a constant rate}
    \choice{Decreasing at a decreasing rate}
    \choice{Decreasing at an increasing rate}    
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice{can conclude the stock's price is decreasing}
    \choice{can conclude the stock's price is increasing}
    \choice[correct]{cannot determine whether the stock's price is increasing or decreasing.}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice[correct]{\includegraphics[scale = 0.3]{increasingconcaveup.jpg}}
    \choice{\includegraphics[scale = 0.3]{increasingconcavedown.jpg}}
    \choice{\includegraphics[scale = 0.3]{decreasingconcavedown.jpg}}
    \choice{\includegraphics[scale = 0.3]{decreasingconcaveup.jpg}}  
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  at $t=1$ hr?
  \begin{image}
    \includegraphics[scale = 1]{speed.jpg}%graph from ASU precalculus assessment of speed of cars
  \end{image}
  \begin{multipleChoice}
    \choice{Car $A$ is ahead of car $B$}
    \choice[correct]{Car $B$ is ahead of car $A$}
...
%% \begin{problem} %%BADBAD tikz doesn't render online
%%   \recommendation{Vic}
...
\begin{problem}
  \recommendation{Elizabeth}
  \GoodQuestions{Subject: Derivative Rules 8P}
  Suppose over an interval of time, $\Delta t$, the length, $L$, and
  the width, $W$, of a rectangle grow to $L+\Delta L$ and $W +\Delta
  W$ respectively as in the sketch below. 
  \begin{image}
    \begin{tikzpicture}
      \coordinate (A) at (0,4);
      \coordinate (B) at (0,2);
      ...
      \draw[decoration={brace,mirror,raise=.2cm},decorate,thin] (.2,2)--(3.8,2);
      \draw[decoration={brace,mirror,raise=.2cm},decorate,thin] (4.2,2)--(4.8,2);
      \draw[decoration={brace,raise=.2cm},decorate,thin] (0,2.2)--(0,3.8);
      \draw[decoration={brace,raise=.2cm},decorate,thin] (0,4.2)--(0,4.8);
      \draw[dashed] (C)--(E)--(F)--(G)--(A);
      \draw[very thick] (A)--(B)--(C)--(D)--cycle;
      \node at (2,2-.5) {$L$};
      \node at (4.5,2-.5) {$\Delta L$};
      \node at (-.5,3) {$W$};
      \node at (-.7,4.5) {$\Delta W$};
      %\node at (6+.5,3.5) {$3$};
    \end{tikzpicture}
  \end{image}
  The average rate of change in the area, $A$, over the time interval
  $\Delta t$ is
  \begin{multipleChoice}
    \choice{$\frac{LW}{\Delta t} + \frac{(\Delta L) (\Delta W)}{\Delta t}$}
    \choice{$\frac{LW}{\Delta t} + L\frac{\Delta W}{\Delta t} + W\frac{\Delta L}{\Delta t} + \frac{\Delta L \Delta W}{\Delta t}$}
    \choice{$L\frac{\Delta W}{\Delta t} + W\frac{\Delta L}{\Delta t}$}
    \choice[correct]{$L\frac{\Delta W}{\Delta t} + W\frac{\Delta L}{\Delta t} + \frac{\Delta L \Delta W}{\Delta t}$}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice{The car was speeding the whole time}
    \choice{The car was speeding more than half the time}
    \choice[correct]{There was at least one moment in time when the car was speeding}
    \choice{The car was never speeding}
    \choice{We don't know if the car was speeding}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice[correct]{$f(x+h) > f(x+h^2)$}
    \choice{$f(x+h) < f(x+h^2)$}
...
\begin{problem}
  ...
  \begin{multipleChoice}
  \choice{the circumference of the trunk.}
  \choice[correct]{the surface area of the trunk.} 
  \choice{the thickness of the growth ring times the surface
    area of the trunk.}    
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  represent?  
  \begin{multipleChoice}
    \choice[correct]{the volume of the rind}
    \choice{the surface area of the orange}
    \choice{the volume of the ``edible part'' of the orange}
    \choice{$-1\times$(the volume of the rind)}
    \choice{none of the above}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  Suppose $f(m)$ is the global minimum value of a function $f$.  Let
  $g(x) = -f(x) \cdot f(x)$.  What must be true about $g$?
  \begin{multipleChoice}
    \choice{$-f(m)^2$ is the global minimum value of $g$}
    \choice{$-f(m)^2$ is the global maximum value of $g$}
    \choice[correct]{$-f(m)^2$ need not be the global maximum or
      minimum value of $g$}
  \end{multipleChoice}
\end{problem}

\begin{problem}
  Suppose $f$ is a function that has a local minimum at $(0,f(0))$ and
  at $(1,f(1))$.  What must be true about $f$?
  \begin{multipleChoice}
...
\begin{problem}
  Suppose $f$ is a continuous function which has a local minimum at $(0,f(0))$ and at $(1,f(1))$.  What must be true about $f$?
  \begin{multipleChoice}
...
%% \begin{problem}
%% BADBAD f(x)= -5 + 1/(1+x^2), but f^2 has more mins
%% \recommendation{Vic}
...
%%     \choice[correct]{The graph of $y = f(x)^2$ has at least as many local minimums as the graph of $y = f(x)$ and could have more}
%%     \choice{The graph of $y = f(x)$ has at least as many local minimums as the graph of $y = f(x)^2$ and could have more}
%%   \end{multipleChoice}
%% \end{problem}
...
\begin{problem}
  ...
  \end{image}
  \begin{multipleChoice}
    \choice{One is a constant multiple of the other.}
    \choice{They are equal.}
    \choice[correct]{It depends on how close the boat is to the dock.}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice{More than $2v$ m/s}
    \choice{Exactly $2v$ m/s}
    \choice[correct]{Less than $2v$ m/s}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  $h$, then
  \begin{multipleChoice}
    \choice{$h$ is an antiderivative of $f$}
    \choice[correct]{$h$ is the second derivative of $f$}
    \choice{$h$ is the derivative of $f''$}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  obtained from the:
  \begin{multipleChoice}
    \choice{Left endpoints}
    \choice{Midpoints}
    \choice{Right endpoints}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    ...
    \choice{$f(4)-f(2)$}
    \choice{$(4-2)f(4)$}
    \choice{the average of $f(4)$ and $f(2)$ times the amount of time that elapsed}    
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    \choice[correct]{The total distance the sprinter ran in one minute}
    \choice{The sprinter's average velocity in one minute}
    \choice{The sprinter's distance from the starting point after one minute}
    \choice{None of the above}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    ...
    \choice{is sometimes positive and sometimes negative.}
    \choice[correct]{is always increasing.}
    \choice{There is not enough information to conclude any of the
above.}
  \end{multipleChoice}
\end{problem}
...
\begin{multipleChoice}
\choice{$\sin(0.005) = 0.005$}
\choice[correct]{$sin(0.005)$ is approximately 0.005}
\choice{$g(x)$ is the best straight-line approximation of $f(x)$ for any value of $x$}
\choice{None of the above}
\end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  \begin{multipleChoice}
    ...
    \choice[correct]{Overall, the company hasn't made money this past year}
    \choice{The company's profits were decreasing but now they are increasing}
    \choice{None of the above}
  \end{multipleChoice}
\end{problem}
...
\begin{problem}
  ...
  compare to $\sin^N b$?
  \begin{multipleChoice}
    \choice{$\sin^N a$ must be very close to $\sin^N b$ because $a \approx b$}
    \choice[correct]{$\sin^N a$ might not be very close to $\sin^N b$ even though $a \approx b$}
  \end{multipleChoice}
\end{problem}
